<?php
	...
	require_once( 'Rich-Web-Slider-Header.php' );
?>
<style type="text/css">
	...
	.Rich_Web_Products_Main_Div { width: 99%; position: relative; margin: 15px 0px; float: left; }
	.Rich_Web_Products_Product_Div { float: left; position: relative; width: 270px; height: 530px; text-align: center; background: #fff; margin-left: 5px; margin-top: 15px; box-shadow:0 1px 4px #6ecae9; -webkit-box-shadow:0 1px 4px #6ecae9; -moz-box-shadow:0 1px 4px #6ecae9; }
	.Rich_Web_Products_Product_Div:before, .Rich_Web_Products_Product_Div:after { content:""; position: absolute; z-index:-1; box-shadow:0 0 20px #6ecae9; -webkit-box-shadow:0 0 20px #6ecae9; -moz-box-shadow:0 0 20px #6ecae9; top:50%; bottom:0; left:10px; right:10px; border-radius:100px / 10px; }
	.Rich_Web_Products_Product_Div img { margin-top: 10px; }
	.Rich_Web_Products_Product_Div p { padding: 0px 15px 10px 15px; text-align: justify; font-size: 14px; line-height: 1.2; color: #30a9d1; }
	.Rich_Web_Products_Product_Div p span { margin-left: 5px; margin-right: 3px; padding: 0px; font-size: 24px; color: #6ecae9; text-shadow: 0px 0px 1px #000; }
	.Rich_Web_Products_Product_Div h1 { display: block; width: 90%; margin: 0 auto; border-top: 1px solid #6ecae9; }
	.Rich_Web_Products_Product_Div a { padding: 8px 0px; box-shadow: 0px 0px 20px #6ecae9 inset; width: 90%; text-decoration: none; color: #30a9d1; position: absolute; left: 5%; bottom: 10px; }
	.Rich_Web_Products_Product_Div a:hover { box-shadow: 0px 0px 20px #30a9d1 inset;}
</style>
<div class="Rich_Web_Products_Main_Div">
	<div class="Rich_Web_Products_Product_Div">
		...
		<a href="http://rich-web.org/wp-contact-form/" target="_blank"> View More </a>
	</div>
	<div class="Rich_Web_Products_Product_Div">
		...
		<a href="http://rich-web.org/wp-image-gallery/" target="_blank"> View More </a>
	</div>
	<div class="Rich_Web_Products_Product_Div">
		...
		<a href="http://rich-web.org/wp-image-slider/" target="_blank"> View More </a>
	</div>
	<div class="Rich_Web_Products_Product_Div">
		...
		<a href="http://rich-web.org/wp-video-slider/" target="_blank"> View More </a>
	</div>
	<div class="Rich_Web_Products_Product_Div">
		...
		<a href="http://rich-web.org/wp-tab-accordion/" target="_blank"> View More </a>
	</div>
	<div class="Rich_Web_Products_Product_Div">
		...
		<a href="http://rich-web.org/wp-coming-soon/" target="_blank"> View More </a>
	</div>
	<div class="Rich_Web_Products_Product_Div">
		<img src="<?php echo plugins_url('/Images/Products/Share-Button.png',__FILE__);?>">
		<h1></h1>
		<p>
		...
		<a href="http://rich-web.org/wp-share-button/" target="_blank"> View More </a>
	</div>
	<div class="Rich_Web_Products_Product_Div">
		<img src="<?php echo plugins_url('/Images/Products/Timeline.png',__FILE__);?>">
		<h1></h1>
		<p>
		...
		<a href="http://rich-web.org/wp-event-timeline/" target="_blank"> View More </a>
	</div>
</div>
